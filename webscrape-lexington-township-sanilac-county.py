...
saleDateRangeStart.send_keys('11/03/2018')
time.sleep(2)
saleDateRangeTo.clear()
saleDateRangeTo.send_keys('10/21/2022')
salePriceRangeMin.send_keys("175,000")
...
for n in total_pages:
    ...
    with open('lexington-township-sanilac-county'+str(n)+'.csv', 'w') as f:  # writes a csv. 50 parcels at a time so it is easier to start up where I left off if the program crashes
        write = csv.writer(f)
